package com.digalyst.myapplication.ui.series
...
class SeriesNetworkCallActivity : AppCompatActivity() {
    ...
    private val viewModel: SeriesNetworkCallsViewModel by viewModels()
    ...
    private fun setupUI() {
        binding.apply {
            recyclerView.layoutManager = LinearLayoutManager(this@SeriesNetworkCallActivity)
            adapter =
                ApiUserAdapter(
                    arrayListOf()
                )
